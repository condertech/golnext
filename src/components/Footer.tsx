  ...
  return (
    <footer className="mt-auto overflow-hidden bg-deep text-sage">
      <div className="mx-auto max-w-6xl px-5 pb-10 pt-5 sm:pt-8 md:px-10">
        <div className="group relative isolate min-h-[600px] overflow-hidden rounded-[24px] bg-deep-soft sm:rounded-[28px] lg:min-h-[440px] lg:rounded-[36px]">
          ...
          <div className="absolute inset-x-2 top-5 h-[285px] sm:inset-x-8 sm:h-[360px] lg:bottom-5 lg:left-[36%] lg:right-4 lg:top-4 lg:h-auto">
            <Image
              src="/IMG_1808.PNG"
          ...
          <div className="absolute inset-x-0 bottom-0 z-10 flex flex-col items-start gap-5 p-5 sm:p-8 lg:inset-0 lg:justify-end lg:p-10">
            <div className="max-w-[460px]">
              <p className="wm text-3xl text-white sm:text-5xl lg:text-[52px]">
