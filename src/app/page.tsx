...
const esportes = [
  {
    nome: "Futebol",
    tipos: "Society, campo e futsal",
    icon: "soccer",
    slug: "futebol",
  },
  {
    nome: "Beach tennis",
    tipos: "Areia, dupla e aula",
    icon: "racket",
    slug: "beach-tennis",
  },
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        <section className="overflow-hidden bg-white px-5 py-16 sm:py-22 md:px-10">
          <div className="relative mx-auto grid max-w-6xl items-center gap-10 overflow-hidden rounded-[2rem] bg-deep px-6 py-10 shadow-[0_28px_70px_rgba(0,53,44,0.18)] sm:px-10 sm:py-12 lg:grid-cols-[1fr_0.8fr] lg:px-14 lg:py-14">
            <div
              className="pointer-events-none absolute -right-24 -top-32 h-80 w-80 rounded-full bg-mint/15 blur-3xl"
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute -bottom-36 left-1/3 h-72 w-72 rounded-full bg-petroleo-400/20 blur-3xl"
              aria-hidden="true"
            />

            <div className="relative z-10">
              <span className="sg inline-flex items-center gap-2 rounded-full border border-mint/25 bg-mint/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-mint">
                <span className="h-2 w-2 rounded-full bg-mint" />
                APP WEB GolNext
              </span>
              <h2 className="wm mt-5 max-w-2xl text-[clamp(36px,6vw,64px)] text-white">
                Seu próximo jogo começa no navegador.
              </h2>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-mist sm:text-lg">
                Acesse a GolNext direto do celular ou computador. Consulte
                horários, encontre quadras e faça sua reserva sem precisar
                baixar nada.
              </p>
              <a
                href="https://app.golnext.com.br"
                target="_blank"
                rel="noreferrer"
                className="wm mt-8 inline-flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-mint px-8 py-4 text-center text-lg text-deep transition hover:-translate-y-0.5 hover:brightness-95 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-mint sm:w-auto"
              >
                Acessar o app GolNext
                <svg
                  viewBox="0 0 24 24"
                  width="21"
                  height="21"
              ...
              <p className="sg mt-4 text-xs text-sage">
            ...
            <div
              ...
              aria-hidden="true"
            >
              <div className="rotate-2 rounded-[2rem] border border-white/15 bg-deepest p-3 shadow-[0_30px_60px_rgba(0,0,0,0.35)] transition duration-500 hover:rotate-0">
                <div className="rounded-[1.4rem] bg-petroleo-50 p-5 sm:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    />
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-petroleo-800 shadow-sm">
                      <svg
                        viewBox="0 0 24 24"
                        width="18"
                        height="18"
                  ...
                  <div className="mt-7 rounded-2xl bg-petroleo-900 p-5 text-white">
                    <p className="sg text-[11px] font-bold uppercase tracking-[0.14em] text-mint">
                      Partida marcada
                    </p>
                    <p className="wm mt-2 text-2xl">Futebol Society</p>
                    <div className="mt-5 flex items-end justify-between border-t border-white/10 pt-4">
                      <div>
                        <p className="text-xs text-sage">Hoje</p>
                        <p className="sg mt-1 font-semibold">19:30</p>
                      </div>
                      <span className="rounded-full bg-mint px-3 py-1.5 text-xs font-bold text-deep">
                        Confirmado
                      </span>
                    </div>
                  </div>
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    <div className="rounded-xl bg-white p-4 shadow-sm">
                      <div className="h-2 w-12 rounded-full bg-petroleo-100" />
                      <div className="mt-3 h-3 w-20 rounded-full bg-petroleo-800" />
                    </div>
                    <div className="rounded-xl bg-white p-4 shadow-sm">
                      <div className="h-2 w-14 rounded-full bg-petroleo-100" />
                      <div className="mt-3 h-3 w-16 rounded-full bg-petroleo-800" />
                    </div>
                  </div>
                </div>
              </div>
